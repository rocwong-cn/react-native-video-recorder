...
import com.yuanyinguoji.video.glutils.GLDrawer2D;
...
public final class CameraGLView extends GLSurfaceView {
    ...
    private static int CAMERA_ID = CAMERA_FACING_BACK;
    ...
    public void swicthCamera() {
        switch (CAMERA_ID) {
            case CAMERA_FACING_BACK:
                CAMERA_ID = CAMERA_FACING_FRONT;
                break;
            case CAMERA_FACING_FRONT:
                CAMERA_ID = CAMERA_FACING_BACK;
                break;
        }
        if (mCameraHandler != null) {
            // just request stop prviewing
...
//				parent.requestRender();
    ...
    private static final class CameraHandler extends Handler {
        ...
        public void startPreview(final int width, final int height) {
            Log.e(TAG, "startPreview1111111111");
...
//				int cameraid = CAMERA_FACING_BACK;
                try {
